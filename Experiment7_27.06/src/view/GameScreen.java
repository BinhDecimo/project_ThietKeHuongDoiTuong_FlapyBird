...
public class GameScreen extends JPanel implements StateObserver {
    ...
    private Image birdImg, heroImg, planeImg;  // Images for different characters
    ...
    private Image getCharacterImage(Character character) {
        ...
        return null;  // Default case, should never happen if the characters are correctly defined
    }
