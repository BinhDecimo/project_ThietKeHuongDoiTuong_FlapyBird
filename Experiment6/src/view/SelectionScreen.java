...
public class SelectionScreen extends JPanel implements SelectionObserver {
	...
	private static final ImageIcon PLANE_ICON = new ImageIcon(
			SelectionScreen.class.getResource("/resources/planeC.png"));
	...
	public SelectionScreen() {
		...
		buttonPanel.setBackground(Color.decode("#D8E2DC")); // Set the background color of the button panel
		...
		// --Sự kiên dể trong Controller--
		birdButton.addActionListener(e -> characterLabel.setIcon(resizeIcon(BIRD_ICON, ICON_WIDTH, ICON_HEIGHT)));
		heroButton.addActionListener(e -> characterLabel.setIcon(resizeIcon(HERO_ICON, ICON_WIDTH, ICON_HEIGHT)));
		planeButton.addActionListener(e -> characterLabel.setIcon(resizeIcon(PLANE_ICON, ICON_WIDTH, ICON_HEIGHT)));
		...
		JButton startButton = new JButton(
				resizeIcon(new ImageIcon(SelectionScreen.class.getResource("/resources/start.png")), 70,30));
	...
	public static void main(String[] args) {
		JFrame frame = new JFrame("Selection Screen");
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.setSize(500, 400);
		frame.setLocationRelativeTo(null);
		frame.setLayout(new BorderLayout());
		JPanel selection = new SelectionScreen();
		frame.add(selection);
