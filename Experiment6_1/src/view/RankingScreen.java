...
public class RankingScreen extends JPanel implements StateObserver {
    ...
    private JLabel label_score1 = new JLabel("100");
    private JLabel label_score2 = new JLabel("200");
    private JLabel label_score3 = new JLabel("300");
    ...
    public RankingScreen(GameModelInterface gameModel, GameControllerInterface gameControl, JFrame mainFrame) {
        ...
        // Thiết lập kích thước của JFrame là 360x640
//        mainFrame.setSize(360, 640);
        
        // Hiển thị JFrame
        mainFrame.setLocationRelativeTo(null); // Đưa JFrame vào giữa màn hình
    ...
    private void setupUIComponents() {
		...
		// Đường dẫn tới hình ảnh your score
		...
		// Đường dẫn tới hình ảnh your top_Higher
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_top_Higher = originalIcon_top_Higher.getImage().getScaledInstance(scaledWidth_top_Higher, scaledHeight_top_Higher, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_name = originalIcon_name.getImage().getScaledInstance(scaledWidth_name, scaledHeight_name, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_score = originalIcon_score.getImage().getScaledInstance(scaledWidth_score, scaledHeight_score, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_rank1 = originalIcon_rank1.getImage().getScaledInstance(scaledWidth_rank1, scaledHeight_rank1, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
     ...
     // Đường dẫn tới hình ảnh rank2
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_rank2 = originalIcon_rank2.getImage().getScaledInstance(scaledWidth_rank2, scaledHeight_rank2, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
     ...
     // Đường dẫn tới hình ảnh rank3
        ...
        // Scale hình ảnh với kích thước mới
        Image scaledImage_rank3 = originalIcon_rank3.getImage().getScaledInstance(scaledWidth_rank3, scaledHeight_rank3, Image.SCALE_SMOOTH);
        // Tạo ImageIcon từ hình ảnh đã scale
        ...
        button_1 = createButton("/resources/menu.png", 70, 30);
		button_2 = createButton("/resources/exit2.png", 70, 30);
		button_3 = createButton("/resources/newGame.png", 70, 30);
 ...
 // hình ảnh nút bấm
    ...
    public static void main(String[] args) {
        // Tạo game model, controller và main frame
        GameModelInterface gameModel = new GameModel();
        JFrame mainFrame = new JFrame("Background Panel Test");
        GameControllerInterface gameController = new GameController(gameModel, mainFrame);

        // Tạo một instance của lớp BackgroundPanel
        RankingScreen ranking = new RankingScreen(gameModel, gameController, mainFrame);
        
        // Thêm BackgroundPanel vào JFrame
        mainFrame.getContentPane().add(ranking);
