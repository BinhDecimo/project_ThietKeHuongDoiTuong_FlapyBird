...
public class SelectionScreen extends JPanel implements SelectionObserver {
   ...
   // private SelectionManager selectionManager;
    ...
    public SelectionScreen(GameModelInterface gameModel, GameControllerInterface gameController) {
    ...
    public static void main(String[] args) {
        ...
        GameControllerInterface gameController = new GameController(gameModel, frame);
        SelectionScreen selectionScreen = new SelectionScreen(gameModel, gameController);
